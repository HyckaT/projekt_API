...
print("################################")
print(f"Stát: {res["sys"]["country"]}\nMěsto: {res["name"]}\nNadmořská výška: {round(transform.feet_to_meters(res["main"]["sea_level"]),2)} m")
print(f"Teplota ve stupních Celsia: {round(transform.kelvin_to_celsius(res["main"]["temp"]),1)}")
